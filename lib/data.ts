...
export const services = [
  ...
  },
  {
    ...
    description: "Upgrade your digital infrastructure without risk. We migrate legacy WordPress and custom systems to high-performance Webflow architectures with zero SEO loss.",
    icon: Rocket,
    features: ["Zero-Downtime Migration", "SEO Integrity Guarantee", "Architecture Modernization", "Custom API Integration"],
  ...
  },
  {
    ...
    description: "Long-term strategic collaboration to scale your digital presence. We act as your fractional CTO and engineering team to drive continuous innovation.",
    icon: Users,
    features: ["Fractional CTO Services", "Team Augmentation", "Strategic Roadmap", "Continuous Optimization"],
